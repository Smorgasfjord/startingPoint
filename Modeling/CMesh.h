...
public:
	...
	static bool loadVertexBufferObjectFromMesh(std::string const & fileName, int & TriangleCount, GLuint & PositionBufferHandle, GLuint & IBH, GLuint & NBH, GLuint & ColorBufferHandle);
